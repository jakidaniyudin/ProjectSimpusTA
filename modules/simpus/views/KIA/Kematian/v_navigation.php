...
<body>
    <div class="mt-4 mb-4">
        <div class="row">
            <div class="col-lg-10 col-md-10 ">
                ...
                <h4 id="title_page">Pelayanan Laporan Kematian Maternal dan Perinatal / Pelayanan Laporan Kematian ibu
                    dan anak</h4>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin mengakhiri pelayanan Kematian ?</p>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var kematianIbu = <?= json_encode($kematian_ibu); ?>;
            var kematianBayiLahirMati = <?= json_encode($kematian_bayi_lahir_mati); ?>;
            console.log(kematianBayiLahirMati);
            var kematianBayiLahirHidup = <?= json_encode($kematian_bayi_lahir_hidup); ?>;
            var obsetri = <?= json_encode($obsetri) ?>;
            synchronizeData(kematianIbu, 'KematianIbu');
            synchronizeData(kematianBayiLahirMati, 'dataLahirMati');
            synchronizeData(kematianBayiLahirHidup, 'dataLahirHidup');
            ...
            if (Array.isArray(menus) && menus.length > 0 && pasienId != null) {
                function buildNavbar() {
                    const order = ['laporan_kematian', 'assessment','status_pasiens'];
                    ...
                    order.forEach((target, index) => {
                        ...
                        if (item) {
                            ...
                            <li>
                                <a href="#" class="${isActive}" data-target="Kematian/${target}">${capitalizedText}</a>
                            </li>
                        `);
                        }
                    });
                    ...
                    $('#navbar-sub-layanan').append(`
                    <li>
                        <a href="#" data-target="Kematian/priview">
            ...
            $('#confirmAkhiri').click(function() {
                const pelayanan = 'Kematian'; // Mengakhiri ANC berarti mengubah pelayanan menjadi null
