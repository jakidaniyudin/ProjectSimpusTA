...
<body>
    <div class="mt-4 mb-4">
        <div class="row">
            <div class="col-lg-10">
                <h4 id="title_page">Pelayanan Neonatus / Pelayanan Anak Baru Lahir</h4>
            </div>
            <div class="col-lg-2">
                <button type="button" data-target="#akhiriNeonatus" class="btn btn-block btn-danger btn-sm">
                    Akhiri Neonatus
                </button>
            </div>
        </div>
    ...
    <div id="layanan-point">
        <nav class="navbar navbar-custom navbar-static-top">
            <div class="container-fluid">
                <!-- Left navbar links -->
                <ul id="navbar-sub-layanan" class="nav navbar-nav neonatus">
                </ul>
            </div>
        </nav>
    ...
    $(document).ready(function() {
        ...
        if (Array.isArray(menus) && menus.length > 0 && pasienId != null) {
            ...
            function buildNavbar() {
                ...
                order.forEach((target, index) => {
                    ...
                    if (item) {
                        ...
                        $('#navbar-sub-layanan').append(`
                            <li class="hidden-xs">
                                <a href="#" class="${isActive}" data-target="Neonatus/${target}">${capitalizedText}</a>
                            </li>
                        `);
                    }
                });
                ...
                $('#navbar-sub-layanan').append(`
                    <li class="hidden-xs">
                        <a href="#" data-target="Neonatus/priview">
            ...
            let activeElement = $('.neonatus a.active-form');
            if (activeElement.length > 0) {
                ...
                let firstTarget = $('.neonatus a').first().data('target');
            ...
            console.log('menu ngak ada bro');
            $('#overlay').hide();
            $('#layanan-point').hide();
            $('#notify').show();
        }

        $('button[data-target="#akhiriNeonatus"]').click(function() {
