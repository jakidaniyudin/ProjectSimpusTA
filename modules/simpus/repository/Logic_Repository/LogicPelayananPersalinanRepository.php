...
class LogicPelayananPersalinanRepository  extends BaseLogicAbstract
{
    ...
    public function set($post, $data)
    {
        try {
            ...
            $id_subLayanan =  $this->CI->MasterSubLayanan_model->getByName('pelayanan_persalinan');
    ...
    public function update($data, $id_record_detail = null)
    {
        ...
        if (empty($batchResult)) {
            throw new ServiceException('not found for collection id and value pelayanan persalinan', 400);
        }
