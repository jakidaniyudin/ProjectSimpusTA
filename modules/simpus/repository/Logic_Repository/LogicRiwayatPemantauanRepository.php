...
class LogicRiwayatPemantauanRepository  extends BaseLogicAbstract
{
    ...
    public function set($post, $data)
    {
        try {
            ...
            $id_subLayanan =  $this->CI->MasterSubLayanan_model->getByName('pemantauan-riwayat');
    ...
    public function create($data, $id_record_detail)
    {
        ...
        return $this->CI->HasilPemeriksaan_model->create($batchResult);
    }
