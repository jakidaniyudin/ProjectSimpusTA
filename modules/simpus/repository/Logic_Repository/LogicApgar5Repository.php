...
class LogicApgar5Repository  extends BaseLogicAbstract
{
    ...
    public function set($post, $data)
    {
        try {
            ...
            $id_subLayanan =  $this->CI->MasterSubLayanan_model->getByName('apgar5');
            ...
            if ($id_record_detail != null) {
                ...
                throw new ServiceException('tidak ditemukan data yang id record apgar 5', 500);
            }
        } catch (Exception $e) {
    ...
    public function update($data, $id_record_detail = null)
    {
        ...
        if (empty($batchResult)) {
            throw new ServiceException('not found for collection id and value apgar5', 400);
        }
