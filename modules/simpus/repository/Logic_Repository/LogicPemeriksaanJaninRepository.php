...
class LogicPemeriksaanJaninRepository  extends BaseLogicAbstract
{
    ...
    protected function check($id_record_detail)
    {
        return $this->CI->HasilPemeriksaan_model->getByRecordDetail($id_record_detail);
    }
}