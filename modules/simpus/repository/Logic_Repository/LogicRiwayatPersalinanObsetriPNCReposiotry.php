...
class LogicRiwayatPersalinanObsetriPNCReposiotry extends BaseLogicAbstract{
    protected $CI;
    ...
    public function set($post, $data) {
        try {
            ...
            $id_subLayanan = $this->CI->MasterSubLayanan_model->getByName('riwayat_persalinan_pnc');
    ...
    public function setRecordDetail($loket_id, $start, $id_subLayanan, $id_pemeriksaan_record, $id_dokter) {
