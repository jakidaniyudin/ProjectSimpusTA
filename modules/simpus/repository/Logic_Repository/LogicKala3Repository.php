...
class LogicKala3Repository  extends BaseLogicAbstract
{
    ...
    public function set($post, $data)
    {
        try {
            ...
            $id_subLayanan =  $this->CI->MasterSubLayanan_model->getByName('kala3');
            ...
            if ($id_record_detail != null) {
                ...
                throw new ServiceException('tidak ditemukan data yang id record kala3', 500);
            }
        } catch (Exception $e) {
