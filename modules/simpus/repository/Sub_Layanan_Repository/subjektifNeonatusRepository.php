...
class subjektifNeonatusRepository implements InterfaceSubLayanan
{
    protected $ci;
    protected $idSubLayanan = 'dfd9898e-4924-11f0-bd23-bc24113678a5';
    ...
    public function loadForm($load, $session, $encryption, $model)
    {
        ...
        $load->view('pelayanan/KIA/Neonatus/pelayanan_form/v_subjectif', $data);
    }
