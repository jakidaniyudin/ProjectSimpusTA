...
class objektifPNCRepository implements InterfaceSubLayanan
{
    protected $ci;
    protected $idSubLayanan = '43bcace1-4541-11f0-bd23-bc24113678a5';
    ...
    public function loadForm($load, $session, $encryption, $model)
    {
        ...
        $load->view('pelayanan/KIA/PNC/pelayanan_form/v_objectif', $data);
    }
