...
class requestBayi implements RequestInterface
{
    protected $CI;
    protected $validator;
    ...
    {
        return [
            'bayi[lokasiPersalinan][value]'         => 'required',
            'bayi[interpretasiBeratBayi][value]'    => 'required',
            'bayi[panjangBayi][value]'              => 'required|numeric',
            'bayi[beratBayi][value]'                => 'required|numeric',
            'bayi[inisiasiMenyusui][value]'          => 'required',
        ];
    }
