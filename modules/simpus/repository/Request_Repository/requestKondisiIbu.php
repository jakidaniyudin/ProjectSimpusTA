...
class requestKondisiIbu implements RequestInterface
{
    protected $CI;
    protected $validator;
    ...
    {
        return [
            'keadaanIbu[keadaanIbu][value]'            => 'required|numeric',

            'keadaanIbu[deskripsiPenolong][value]'     => 'required',

            'keadaanIbu[deskripsiKeadaanIbu][value]'   => 'required',

            'keadaanIbu[caraPersalinan][value]'        => 'required|numeric',

            'keadaanIbu[penolongPersalinan][value]'    => 'required|numeric',
        ];
    }
    ...
    public function setDataRequest($request)
    {
        ...
        $request =  $request->post('keadaanIbu');
        $data =  [];
        if (!empty($data)) {
            return $data;
        } else {
