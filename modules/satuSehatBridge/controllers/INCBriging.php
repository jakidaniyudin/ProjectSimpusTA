...
require_once(APPPATH . 'modules/satuSehatBridge/service/serviceLogicINCIntegration.php');

class INCBriging extends CI_Controller {
    protected  $logicServiceIntergration;
    protected $response;
    public function __construct(){
        parent::__construct();
        $this->load->library('curl');
        $this->logicServiceIntergration =  new serviceLogicINCIntegration();
    ...
    public function sendSatuSehatBundle (){
        try {
            $response = $this->logicServiceIntergration->sendINC($this->input);
